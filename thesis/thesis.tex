...
%! Descrizione (specifiche) del computer usato per fare le run
...
%! Funzioni usate per misurare il tempo di esecuzione
...
%! Descrizione del test-bed usato (MIPLIB 2003 + 2010 + 2017)
%! + uso di 3/5 random seeds diversi per espanderlo ulteriormente e verificare l'effetto della performance variability
...
%* Elenco delle varianti di ZI-Round testate
%? Sezioni separate ?
