...
\begin{itemize}
	\item \textit{favorable rounding strategy}:
	\item \textit{unfavorable rounding strategy}:
	\item \textit{nearest integer rounding strategy}:
	\item \textit{gap rounding strategy}:
\end{itemize}
